...
const AdminPage: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
      <h1 className="text-3xl font-bold mb-6 border-b pb-4 text-gray-800 dark:text-white">
        Trang Quản Trị - Tạo/Sửa Sản Phẩm
      </h1>
      ...
      <form onSubmit={handleSaveProduct} className="space-y-6">
        ...
        <div>
          <label
            ...
            className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
          >
            Các tính năng chính (mỗi tính năng một dòng)
          </label>
          <textarea
            id="productFeatures"
            rows={4}
        ...
        <div>
          ...
          <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
            Chỉnh sửa nội dung do AI tạo ra và định dạng tại đây.
          </p>
        </div>
