...
const PricingCard: React.FC<PricingCardProps> = ({ product }) => {
  ...
  return (
    <div
      className={`relative border-4 border-leaf-green rounded-2xl p-6 flex flex-col transition-transform transform hover:scale-105 duration-300 shadow-xl ${
        product.popular
          ? 'bg-gradient-to-br from-orange-50 to-amber-50 dark:from-gray-800 dark:to-gray-800/80'
    ...
    >
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-4xl font-extrabold text-cosmic-orange mt-4">
          ...
          {product.features.map((feature, index) => (
            <li key={index} className="flex items-center">
              <svg
                ...
                className="h-6 w-6 text-leaf-green mr-3"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
