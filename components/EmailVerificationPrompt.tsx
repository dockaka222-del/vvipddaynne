  ...
  return (
    <div className="text-center p-10 bg-white dark:bg-gray-800 rounded-lg shadow-md border-2 border-yellow-400">
      ...
      <p className="text-gray-600 dark:text-gray-400 mb-6">
        Để tiếp tục thanh toán, bạn cần xác thực địa chỉ email. Vui lòng kiểm
        tra hộp thư đến tại <span className="font-bold">{user?.email}</span>.
      </p>
      ...
      <p className="text-xs text-gray-500 mt-4">
        (Trong thực tế, bạn sẽ cần nhấp vào liên kết trong email của mình để xác
        thực)
      </p>
    </div>
  );
